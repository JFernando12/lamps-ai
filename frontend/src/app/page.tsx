...
const FAQS = [
  {
    ...
    a: 'Antes de pagar puedes ver el preview gratis — si no te convence, no compras. Y si ya pagaste y el diseño no te satisface, lo rehacemos sin costo adicional.',
  },
  {
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-3">
              Ve cómo queda con{' '}
              <span className="text-amber-400">tu foto</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                step: '02',
                title: 'Ve el diseño gratis',
                desc: 'Generamos tu preview al instante para que veas exactamente cómo queda antes de pagar. Sin sorpresas.',
              },
              {
      ...
      <section className="py-12 md:py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-extrabold text-center mb-3">
            Perfecto para{' '}
            <span className="text-amber-400">cada ocasión</span>
          </h2>
          ...
          <div className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 border border-amber-500/20 rounded-3xl p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                {/* Guarantee */}
                <div className="flex items-start gap-3 bg-green-500/10 border border-green-500/20 rounded-xl p-3 mb-5">
                ...
                <div className="flex items-end gap-3 mb-2">
                  ...
                  <div className="mb-2">
                    ...
                    <span className="text-white/40 text-sm">MXN · envío gratis</span>
                  </div>
                </div>
                {/* Urgency */}
                <p className="text-amber-400/80 text-xs mb-6 flex items-center gap-1.5">
                  <Zap size={12} />
                  Producción limitada — pocos pedidos por semana para garantizar calidad
                </p>
      ...
      <footer className="py-12 px-4 border-t border-white/10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-white/30 text-sm">
          <div className="flex flex-col items-center md:items-start gap-1">
            <span className="font-bold text-amber-400 text-lg">The Dream Gift</span>
            <p>© {new Date().getFullYear()} The Dream Gift. Todos los derechos reservados.</p>
          </div>
          {/* Social */}
          ...
          <div className="flex gap-6">
            ...
            <a href="mailto:hola@thedreamgift.mx" className="hover:text-white transition-colors">Contacto</a>
          </div>
        </div>
      </footer>
