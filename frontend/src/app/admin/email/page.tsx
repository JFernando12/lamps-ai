...
export default function EmailMarketingPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-56px)] overflow-hidden bg-[#0a0a0a] text-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Mobile tabs */}
        <div className="lg:hidden flex overflow-x-auto gap-1 px-4 py-3 border-b border-white/8 shrink-0">
          {NAV.map(({ id, label, icon: Icon }) => (
            <button
              key={id}
              onClick={() => setSection(id)}
